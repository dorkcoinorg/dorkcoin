...
#if defined(NDEBUG)
# error "Dorkcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Dorkcoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
    ...
    // Dorkcoin: in v2 transactions use GetAdjustedTime() as TxTime
...
void ThreadScriptCheck() {
    RenameThread("dorkcoin-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Dorkcoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Dorkcoin also requires low S in sigs
