 ...
 * between dorkcoind, and dorkcoin-qt and non-server tools.
*/
...
std::string LicenseInfo()
{
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Dorkcoin Developers", 2026)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Dorkcoin useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Dorkcoin More version %s\n", FormatFullVersion());
}
