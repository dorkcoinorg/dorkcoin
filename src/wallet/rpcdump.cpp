...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"dorkcoinaddress\"\n"
            "\nReveals the private key corresponding to 'dorkcoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"dorkcoinaddress\"   (string, required) The dorkcoin address for the private key\n"
            "\nResult:\n"
