...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dorkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dorkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dorkcoin transaction") + "\n" +
              "  dorkcoin-tx [options] -create [commands]   " + _("Create hex-encoded dorkcoin transaction") + "\n" +
              "\n";
